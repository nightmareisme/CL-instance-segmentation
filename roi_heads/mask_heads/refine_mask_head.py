...
class RefineMaskHead(nn.Module):
    ...
    def forward(self, instance_feats, semantic_feat, rois, roi_labels, return_instance_feats=False):
        ...
        for i, stage in enumerate(self.stages):
            ...
            if i == 0 and return_instance_feats:
                returned_instance_feats = instance_feats
        ...
        if return_instance_feats:
            return stage_instance_preds, semantic_pred, returned_instance_feats
