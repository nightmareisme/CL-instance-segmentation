...
data_root = '/opt/10T/home/asc005/hf/maskkkkkkkkkkkkkkk/pig-rfmask/data/' # change this to your own path
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        type='CocoDataset',
        ann_file='annotations/instance-train1.json',
        img_prefix='images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
