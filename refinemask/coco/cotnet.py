...
data_root = '/opt/10T/home/asc005/hf/maskkkkkkkkkkkkkkk/rfmask-p/data/pig/'  
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=1,
    train=dict(
        type='CocoDataset',
        ann_file='annotations/instance-train.json',
        img_prefix='images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
evaluation = dict(metric=['bbox', 'segm'], classwise=True, interval=36)
