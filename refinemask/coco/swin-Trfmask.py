...
model = dict(
    pretrained='/opt/10T/home/asc005/hf/maskkkkkkkkkkkkkkk/pig-rfmask/pretrained/swin_tiny_patch4_window7_224.pth',
    type='MaskRCNN',
    backbone=dict(
...
data_root = '/opt/10T/home/asc005/hf/maskkkkkkkkkkkkkkk/data' # change this to your own path
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=4,
    train=dict(
